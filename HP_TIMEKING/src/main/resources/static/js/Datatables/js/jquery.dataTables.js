...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"sProcessing": "<img src='" + sDatatablesContextPath + "/img/Loading/loading_type2.gif' style='width:35px;height:35px'/>",
